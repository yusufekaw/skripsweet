...
$data = mysqli_query($conn,"select * from audusd where ".month(37));

//deklarasi variabel bobot
$w1; $w2; $w3; $w4; $w5; $w6; $w7; $w8; $w9; $w10;  $w11; $w12; 
$v1; $v2; $v3; $v4;

    //pembobotan awal diberikan secara acak
    //bobot dari unit input menuju hidden layer
    $w1 = rand(0,100)/100;
    $w2 = rand(0,100)/100;
    $w3 = rand(0,100)/100;
    $w4 = rand(0,100)/100; 
    ...
    $w11 = rand(0,100)/100; 
    $w12 = rand(0,100)/100;
    //bobot dari unit hidden layer menuju unit output layer
    $v1 = rand(0,100)/100;
    $v2 = rand(0,100)/100;
    $v3 = rand(0,100)/100;
    $v4 = rand(0,100)/100;
...
do
{
    ...
    foreach($dataset as $d)
    {
        ...
        /*/*if($eppoach==99)
		//{
			$check_duplicate = mysqli_query($conn, "select * from offline where id=".$d['id']);
			if(mysqli_fetch_array($check_duplicate) == true)
			{
				mysqli_query($conn,"update offline set
					prediksi = ".$out.",
					w1 = ".$w1.",
					w2 = ".$w2.",
					w3 = ".$w3.",
			...
			{
				mysqli_query($conn,"insert into offline values(
					".$id.",
					".$out.",
					".$w1.",
					".$w2.",
