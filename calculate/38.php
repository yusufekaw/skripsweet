...
$data = mysqli_query($conn,"select * from audusd where ".month(36));

$model_from = mysqli_query($conn, "select * from offline ofl join audusd au on ofl.id=au.id WHERE squared=(select min(squared) from offline) and ".month(37));
