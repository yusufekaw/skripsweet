...
$data = mysqli_query($conn,"select * from audusd where ".month(12));

$model_from = mysqli_query($conn, "select * from online onl join audusd au on onl.id=au.id WHERE squared=(select min(squared) from online) and ".month(11));
